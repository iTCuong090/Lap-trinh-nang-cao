...
public class WordCounter {
    ...
    public void analyze(String text) {
        ...
        // xuống dòng, vv), + có nghĩa là từ 1 trở lên, \ là kí tự thoát"
        String[] words = cleanText.split("\\s+");

        //Duyệt mảng và đưa vào HashMap
    ...
    public void findMostFrequentWord() {
        ...
        if (mostFrequent != null) {
            System.out.println("=> Từ khóa chính: '" + mostFrequent + "' với " + maxCount + " lần xuất hiện.");
        }
    }
